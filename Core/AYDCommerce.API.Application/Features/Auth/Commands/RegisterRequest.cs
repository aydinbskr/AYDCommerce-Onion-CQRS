...
namespace AYDCommerce.API.Application.Features.Auth.Commands
{
    ...
    public class RegisterRequestHandler : BaseHandler, IRequestHandler<RegisterRequest, Unit>
    {
        private readonly AuthRules authRules;
        private readonly UserManager<User> userManager;
        private readonly RoleManager<Role> roleManager;

        public RegisterRequestHandler(AuthRules authRules, UserManager<User> userManager, RoleManager<Role> roleManager, IMapper mapper, IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor) : base(mapper, unitOfWork, httpContextAccessor)
        {
        ...
        public async Task<Unit> Handle(RegisterRequest request, CancellationToken cancellationToken)
        {
            ...
            User user = mapper.Map<User, RegisterRequest>(request);
